...
function makebutton(){
  ...
  SuperButton1.mousePressed(playgame())
}
...
function setup() {
  ...
  backgroundImage = loadImage("platformgameimages/download.png")
  mainCharacterImage = loadImage("platformgameimages/images.png")
  monsterImage = loadImage("platformgameimages/SpriteEntity.png")
